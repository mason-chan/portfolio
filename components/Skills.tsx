    ...
    <div className="container relative flex flex-col justify-center items-center max-w-7xl py-20 px-10 mx-auto sm:px-20 md:px-32 lg:px-16 min-h-screen">
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 lg:gap-16 pt-[32px]'>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">HTML5</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          <path
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">CSS3</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          <path
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">JavaScript</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">TypeScript</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          <g fill="#F5D1C8">
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">React</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          <g fill="#F5D1C8">
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">Next.js</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          <path
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">TailwindCSS</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          <defs>
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">BootStrap</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          <path
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">Git</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          <g fill="#F5D1C8">
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">Github</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          <g fill="#F5D1C8">
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">GraphQL</p>
        </motion.div>
        <motion.div initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 1}} viewport={{once: true}} className='flex flex-col items-center justify-center group'>
          <motion.svg whileHover={{scale: 1.1}} viewBox="0 0 128 128" className='object-cover w-20 md:w-24 h-auto xl:w-32'>
          ...
          <p className="group-hover:visible md:invisible lg:inline mt-4 text-lg text-gray-400 tracking-widest">PostgreSQL</p>
        </motion.div>
      </div>
    </div>
  );
